...
class FakePersonCprTest extends TestCase {
  ...
  public function test_Cpr_IsString($value, $exp) {
    $this->fakeInfo->method('getFakePerson')->willReturn(['CPR' => $value]);
  ...
  public static function provide_Cpr_ContainsValidDate() {
    return [
      ...
      ['0201700000'],   // Unix epoch - day after
      ['3112690000'],   // Unix epoch - day prior
   ...
   * 
   * @dataProvider provide_Cpr_ContainsInvalidDates
   */
  ...
  public static function provide_Cpr_ContainsInvalidDates() {
    return [
